...
namespace QianXiong\Internal\Resource;

class V2RequestResource
{
    public static $resourceArray = [
        'operations' => [
            'createBucket' => [
                'httpMethod' => 'PUT',
                'data' => [
            ...
            'putObject' => [
                ...
                'requestParameters' => [
                    ...
                    'Expires' => [
                        'location' => 'header',
                        'type' => 'string',
                        'sentAs' => 'x-amz-expires',
                    ],
                    'Tagging' => [
                        'location' => 'header',
                        'type' => 'string',
                        'sentAs' => 'x-amz-tagging',
                    ]
                ],
                'responseParameters' => [
                    'type' => 'object',
            ...
            'copyObject' => [
                ...
                'requestParameters' => [
                    ...
                    'TaggingDirective' => [
                        'location' => 'header',
                        'type' => 'string',
                        'sentAs' => 'x-amz-tagging-directive',
                    ],
                ],
                'responseParameters' => [
                    'type' => 'object',
