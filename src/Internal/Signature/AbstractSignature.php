...
namespace QianXiong\Internal\Signature;

use GuzzleHttp\Psr7\Stream;
use QianXiong\Internal\Common\Model;
use QianXiong\Internal\Common\ObsTransform;
use QianXiong\Internal\Common\SchemaFormatter;
use QianXiong\Internal\Common\V2Transform;
...
abstract class AbstractSignature implements SignatureInterface
{
    ...
    protected function prepareAuth(array &$requestConfig, array &$params, Model $model)
    {
        ...
        if ($xml || (isset($requestConfig['data']['xmlAllowEmpty']) && $requestConfig['data']['xmlAllowEmpty'])) {
            ...
            ObsLog::commonLog(LogLevel::DEBUG, 'request content ' . $result['body']);
